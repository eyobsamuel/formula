...
class PlaceholderWidget extends WidgetType {
  ...
  toDOM() {
    ...
    container.className =
      "p-1 box-border whitespace-nowrap border border-solid rounded font-medium bg-gray-900 bg-opacity-10 text-gray-900 border-gray-300 divide-x divide-slate-950 > * + *";
    wrap.innerHTML = this.label;
    wrap.className =
      "p-1 relative box-border whitespace-nowrap font-medium text-gray-900 border-gray-300";
